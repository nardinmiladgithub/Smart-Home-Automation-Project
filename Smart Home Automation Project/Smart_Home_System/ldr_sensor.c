...
uint16 LDR_getLightIntensity(void)
{
    ...
    // When the voltage is 0, intensity is 0 (darkness).
    // When the voltage is equal to LDR_SENSOR_MAX_VOLT_VALUE, intensity is LDR_SENSOR_MAX_LIGHT_INTENSITY (maximum light).
